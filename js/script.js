...
//         for (e in s)
//           r[e] =
//             "object" != typeof r[e] || i(r[e]) ? r[e] || s[e] : o(r[e], s[e]);
//       }
//       return r;
//     }
//     function r(t) {
...
//       }),
//       (s.cutsTheMustard =
//         "undefined" != typeof l && l.rAF && l.bind && l.classList),
//       (t.Headroom = s);
//   })(window, document),
//   !(function(t, e, n, i) {
//     var o = t(e);
...
//           t.extend(h, r)),
//         (l = h.container === i || h.container === e ? o : t(h.container)),
//         0 === h.event.indexOf("scroll") &&
//           l.bind(h.event, function() {
//             return s();
//           }),
//         this.each(function() {
//           var e = this,
...
//           s >= t(n).offset().top + r.threshold + t(n).height()
//         );
//       }),
...
//           s >= t(n).offset().left + r.threshold + t(n).width()
//         );
//       }),
...
window.addEventListener("scroll", function(e) {
  ...
  console.log(offset);
  offset >= 5
    ? header.classList.add("header--unpin")
    :6>=offset && header.classList.remove("header--unpin");
});
